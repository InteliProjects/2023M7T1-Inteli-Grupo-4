...
# Reply with a hello world message when the root endpoint is hit
@application.route("/")
def hello():
    return "Hello World!"
...
@application.route("/products/<int:product_id>", methods=["GET"])
...
@application.route("/products/<int:product_id>", methods=["PUT"])
...
@application.route("/products/<int:product_id>", methods=["DELETE"])
...
@application.route("/baskets/<int:basket_id>/products", methods=["POST"])
...
@application.route("/users/<int:user_id>/basket/products", methods=["GET"])
...
@application.route(
    "/baskets/<int:basket_id>/products/<int:product_id>", methods=["DELETE"]
)
...
@application.route("/baskets/<int:basket_id>/checkout", methods=["POST"])
...
@application.route("/create_tables", methods=["GET"])
